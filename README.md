...
Работа в сфере IT требует постоянного саморазвития и обладания широким кругом компетенций.

Обладаю навыками **ui/ux дизайна**.

В 2023 году закончила курсы **Тестировщика ПО** от Нетологии, ниже перечислены мои учебные проекты.

Знакомлюсь с языками програмирования.

Изучаю языки разметки (HTML, markdown, AsciiDoc).

Быть вечным студентом неплохо, если ты умеешь применять полученые навыки на практике.


#### Учебные проекты на курсе Тестировщик ПО:
...
- [Дипломный проект](https://github.com/FecklaSveckla/Diplom/blob/main/README.md) "Автоматизация тестирования комплексного сервиса покупки тура, взаимодействующего с СУБД и API Банка".
  ...
  #### Мои навыки в области тестирования ПО:
